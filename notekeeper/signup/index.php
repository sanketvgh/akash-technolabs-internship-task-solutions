        ...
        <div class="d--f jc--c" style="flex-grow: 3">
               ...
               <form action='' class='form' id='signupForm'>
                <r-grid columns=2 class='form'>
                    <r-cell span=row>
                        <h2 style='text-align: center; margin-bottom: 32px'>Signup</h2>
                    </r-cell>
                    <r-cell span=row>
                        <label for="name" class="form__lable">Name</label>
                        <input type="text" class='form__input' id='name' name='name' placeholder="Enter your Name">
                        <p id='nameMsg' class="form__message"></p>
                    </r-cell>
                    <r-cell span=row>
                    ...
                    <r-cell span=row>
                        <input type="submit" class='form__input button-primary' name='submit' value='Signup'>
                    </r-cell>
                      </r-grid>
                    </form>
